...
namespace Data.Repos {
	...
	public class RecipeIngredientsRepo : RepoBase<RecipeIngredient> {
		public RecipeIngredientsRepo(IConfiguration configuration) : base(configuration)
		{
		}
		...
		public override void Delete(int id) {
			var toBeDeleted = _context.RecipeIngredients.SingleOrDefault(x => x.RecipeIngredientId == id);
			if (toBeDeleted != null) {
