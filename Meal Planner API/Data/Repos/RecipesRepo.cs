...
namespace Data.Repos {
	...
	public class RecipesRepo : RepoBase<Recipe> {
		public RecipesRepo(IConfiguration configuration) : base(configuration)
		{
		}
		...
		public override Recipe? Get(int id) {
			return _context.Recipes.SingleOrDefault(r => r.RecipeId == id);
		}
		...
		public override void Delete(int id) {
			var toBeDeleted = _context.Recipes.SingleOrDefault(x => x.RecipeId == id);
			if (toBeDeleted != null) {
